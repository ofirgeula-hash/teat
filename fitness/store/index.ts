...
function ex(
  ...
  notes: string[],
  sets: PlanSet[],
  variants?: PlanExercise['variants'],
): PlanExercise {
  return { id, name, equipment, notes, sets, ...(variants ? { variants } : {}) };
}
  ...
  },
  {
    ...
    exercises: [
      ...
      ex('l1w2e2', 'טי-באר', ['plates'],
        ...
        [s(10, 45, 90), s(10, 45, 90), s(10, 25, 90), s(10, 25, 90)],
      ),
      ...
      ex('l1w2e7', 'כפיפת יד-יד בפולי תחתון', ['machine'],
        ...
        [s(10, 9, 60), s(12, 14, 60), s(10, 14, 60)],
      ),
      ex('l1w2e8', 'פטישים בישיבה', ['dumbbells'], [],
        [s(10, 10, 60), s(8, 10, 60)],
      ),
    ],
  },
  {
...
const defaultPlans: LocationWorkoutPlan[] = [
  ...loc1Plans,
  {
    ...
    exercises: [
      ex('l2w1e1', 'שכיבות סמיכה', [], [], s3(15, 0, 60)),
      ex('l2w1e2', 'שכיבות סמיכה צרות (טריצפס)', [], [], s3(12, 0, 60)),
    ],
  },
  {
    locationId: 'loc2', workoutTypeId: 'wt2',
    exercises: [
      ex('l2w2e1', 'מתח', [], [], s3(8, 0, 90)),
      ex('l2w2e2', 'כפיפת יד עם משקולות', [], [], s3(12, 10, 60)),
    ],
  },
  {
    locationId: 'loc2', workoutTypeId: 'wt3',
    exercises: [
      ex('l2w3e1', 'לחיצת כתפיים במשקולות', [], [], s3(12, 10, 60)),
    ],
  },
  {
    locationId: 'loc2', workoutTypeId: 'wt4',
    exercises: [
      ex('l2w4e1', 'סקוואט', [], [], s3(15, 0, 90)),
      ex('l2w4e2', "לאנג'", [], [], s3(12, 0, 60)),
    ],
  },
];
